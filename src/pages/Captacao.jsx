      ...
      <div className="box">
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              {lista.filter(c => c.captadoPor === usuarioAtual?.usuario).length === 0
              ...
              {lista.length === 0
                ...
                : lista.map(c => (
                  <tr key={c.id}>
                    ...
                    <td><span style={{ color: c.carregou ? '#4ade80' : 'var(--muted)', fontWeight: 700, fontSize: 12 }}>{c.carregou ? '✓ Sim' : '— Não'}</span></td>
